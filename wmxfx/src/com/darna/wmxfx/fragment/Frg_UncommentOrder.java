...
public class Frg_UncommentOrder extends Fragment {
	ListView mListView;
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View view = inflater.inflate(R.layout.frg_uncommentorder, container, false);
	...
	private void getData() {
		new NetHistoryOrder(getActivity(), Config.getCachedToken(getActivity()), "2", new NetHistoryOrder.SuccessCallback() {
