...
public class DialogIntergral extends ListActivity{
	ListView mListView;
	...
	@Override
	public void finish() {
		Intent intent = new Intent(DialogIntergral.this, Aty_Order.class);
		intent.putExtra(Config.KEY_RETURNCODE, code);
		setResult(Config.DIALOG_INTERGRAl, intent);
		super.finish();
	}
